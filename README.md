...
> | 9. [백준 2587번 곱셈 - 22년 2월 9일]() | 곱셈의 표현 |
> | 10. [백준 11720번 숫자의 합 - 22년 2월 9일]() | 순차적으로 더해서 나오는 값을 구한다. |
...
> | [14. 백준 1152번 단어의 개수 - 22년 2월 7일]()   | 문자열이 나올때마다 카운트를 세고 공백이 나오면 카운트를 세는 간단한 방식으로 해결함                                              |
...
> | DP 알고리즘                 |설명|
> |---------------|------|
> | [1.백준 1463번 1로 만들기 - 22년 2월 9일 ]() | 좀 더 생각해봐야할듯...? |
