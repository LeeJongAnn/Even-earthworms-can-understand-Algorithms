...
> |[5. 증가수열 - 8월 6일]()|왼쪽과 오른쪽을 번갈아가면서 뽑고 마지막에 뽑은값과 비교하여 수열에 집어넣는다 while 문을 이용하고 왼쪽끝과 오른쪽 끝을 lt 와 rt로 선언한다|
> |[6. 역수열 - 8월 6일]()|1부터 순서대로 앞에 빈자리가 있어야 한다|
> |[7. 백준 11047 동전으로 지불하기]()|