...
> | [20. 백준 2675번 문자열반복 - 22년 3월 11일](https://github.com/LeeJongAnn/Even-earthworms-can-understand-Algorithms/blob/master/%EA%B5%AC%ED%98%84/%EB%AC%B8%EC%9E%90%EC%97%B4%EB%B0%98%EB%B3%B5%20-%20%EB%B0%B1%EC%A4%80%202675%EB%B2%88.py)| ~~숫자a가 3이고 b의 문자가 3개지만 인덱스는 0부터 2까지 표현된다. 그럼 범위를 벗어나서 오류가 발생하는데 이 부분을 해결해야된다.~~ 해결이 안돼서 반복문을 분리한뒤 따로 풀었다. 하지만 답은 맞게 나오지만 채점하면 틀린다.(맞왜틀)
