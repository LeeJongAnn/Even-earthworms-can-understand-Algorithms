...
> | [19. 백준 2908번 상수 - 22년 3월 6일]()                                                                                                                                                                                                                              | 거꾸로 뒤집는걸 몰라서 한땀한땀 뒤집다가 40분이나 헤매다 풀었음                                                         |
> | [20. 백준 2675번 문자열반복 - 22년 3월 11일]()| ~~숫자a가 3이고 b의 문자가 3개지만 인덱스는 0부터 2까지 표현된다. 그럼 범위를 벗어나서 오류가 발생하는데 이 부분을 해결해야된다.~~ 해결이 안돼서 반복문을 분리한뒤 따로 풀었다. 하지만 답은 맞게 나오지만 채점하면 틀린다.(맞왜틀)
